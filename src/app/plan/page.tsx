...
export default function Plan() {
  ...
  return (
    <div className="h-dvh">
      ...
      <section className="flex flex-col p-4 mx-4 border rounded-[8px] h-[calc(100dvh_-_(230px))] overflow-y-auto scroll-hidden gap-2">
        <div className="flex items-center gap-3 mx-auto">
          <Button variant="ghost" className="cursor-pointer" onClick={previous}>
        ...
        <ul className="relative flex flex-col w-full mt-4 gap-7">
          <li className="flex gap-4 items-center">
            <span className="w-9 h-9 rounded-full bg-secondary-600 text-white text-center leading-9 font-bold">
              1
            </span>
            {/* <Image
              // TODO: 임시 이미지
